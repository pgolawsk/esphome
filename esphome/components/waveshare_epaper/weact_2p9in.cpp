...
static const char *const TAG = "weact_2.90";
...
static const uint8_t RAM_Y_START[] = {0x45, 0x00, 0x00, uint8_t(296 - 1),
                                      (296 - 1) >> 8};  // set ram_y_address_start_end
...
void WeActEPaper2P9In::write_lut_(const uint8_t *lut) {
...
void WeActEPaper2P9In::write_buffer_(uint8_t cmd, int top, int bottom) {
  this->wait_until_idle_();
...
void WeActEPaper2P9In::send_reset_() {
...
void WeActEPaper2P9In::set_window_(int t, int b) {
  uint8_t buffer[3];
...
void WeActEPaper2P9In::initialize() {}

void WeActEPaper2P9In::partial_update_() {
  this->send_reset_();
...
void WeActEPaper2P9In::full_update_() {
...
int WeActEPaper2P9In::get_width_controller() { return 128; }
int WeActEPaper2P9In::get_width_internal() { return 122; }

int WeActEPaper2P9In::get_height_internal() { return 296; }

uint32_t WeActEPaper2P9In::idle_timeout_() { return 5000; }

void WeActEPaper2P9In::dump_config() {
  LOG_DISPLAY("", "WeAct E-Paper", this)
  ESP_LOGCONFIG(TAG, "  Model: 2.90in");
...
void WeActEPaper2P9In::set_full_update_every(uint32_t full_update_every) {
