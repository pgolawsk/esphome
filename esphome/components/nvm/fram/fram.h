...
static const FramModel FRAM_MODELS[] = {
...
class FramPlatform : public NvmPlatform, public i2c::I2CDevice {
 public:
  void setup() override;
  ...
  void set_model_config(uint32_t size_bytes, uint8_t address_width) {
 ...
 protected:
  ...
  FramModel model_{32 * 1024, 2};  // Default: MB85RC256
};
