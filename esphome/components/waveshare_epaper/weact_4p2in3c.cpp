...
// https://github.com/ZinggJM/GxEPD2/src/epd3c/GxEPD2_420c.cpp
// - The datasheet is here
// https://github.com/WeActStudio/WeActStudio.EpaperModule/blob/master/Doc/E042A88-A1 Spec.pdf
// https://github.com/WeActStudio/WeActStudio.EpaperModule/blob/master/Doc/SSD1683.PDF

static const char *const TAG = "weact_4.20_3c";
...
int WeActEPaper4P2In3C::get_width_internal() { return WIDTH; }
int WeActEPaper4P2In3C::get_height_internal() { return HEIGHT; }
uint32_t WeActEPaper4P2In3C::idle_timeout_() { return 2500; }

void WeActEPaper4P2In3C::dump_config() {
  LOG_DISPLAY("", "WeAct E-Paper (3 Color)", this)
  ESP_LOGCONFIG(TAG, "  Model: 4.20in Red+Black");
...
void WeActEPaper4P2In3C::send_reset_() {
...
void WeActEPaper4P2In3C::initialize() {}

void WeActEPaper4P2In3C::deep_sleep() { SEND(SLEEP); }

// Pixel stuff

// t and b are y positions, i.e. line numbers.
void WeActEPaper4P2In3C::set_window_(int t, int b) {
  SEND(RAM_X_RANGE);
  SEND(RAM_Y_RANGE);
  SEND(RAM_X_POS);
...
void WeActEPaper4P2In3C::write_buffer_(int top, int bottom) {
...
void HOT WeActEPaper4P2In3C::draw_absolute_pixel_internal(int x, int y, Color color) {
...
void WeActEPaper4P2In3C::full_update_() {
...
void WeActEPaper4P2In3C::display() {
